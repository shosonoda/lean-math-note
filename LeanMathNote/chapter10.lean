...
lake build
lake exe mdgen LeanMathNote out
```
...
この講義資料では `lake exe mdgen LeanMathNote out` により，
`LeanMathNote/` 配下の `.lean` ファイルから Markdown を生成しています．
-/
