...
| 段階 | 実体 | 見方 |
| --- | --- | --- |
| 文字列としてのソースコード | `.lean` ファイルや標準入力から渡される Unicode 文字列です．まだ Lean の構文木ではありません． | エディタで開く，`cat LeanMathNote/basic/chapter05.lean` で見る，`lake env lean --stdin` に文字列を渡す． |
...
.lake/build/lib/lean/LeanMathNote/basic/chapter05.olean
.lake/build/lib/lean/LeanMathNote/basic/chapter05.ilean
.lake/build/lib/lean/LeanMathNote/practice/chapter01.olean
.lake/build/lib/lean/LeanMathNote/practice/chapter01.ilean
```

この章のように `LeanMathNote/basic/chapter05.lean` を単体で `lake env lean` した場合は，
...
lake lean LeanMathNote/basic/chapter05.lean
lake build
```
...
```bash
lake env lean --json LeanMathNote/basic/chapter05.lean
```
...
```bash
lake env lean --deps LeanMathNote/basic/chapter05.lean
lake env lean --src-deps LeanMathNote/basic/chapter05.lean
lake env lean --profile LeanMathNote/basic/chapter05.lean
lean --print-prefix
lean --print-libdir
...
LeanMathNote/basic/chapter05.lean      module LeanMathNote.basic.chapter05
...
lake exe <name> ...   # executable をビルドして実行する
...
9. module 名とファイルパスの対応を説明してください．
    ...
    LeanMathNote/basic/chapter05.lean
